  ...
  th: {
    ...
    items: [
      ...
      },
      {
        ...
        aboutEvent: "บริษัท อโณณา เฮ้าส์ (ANONA House) เป็นทีมงานมืออาชีพผู้ให้บริการจัดงานอีเวนต์และการประชุมสัมมนาครบวงจร ทั้งงานเปิดตัวสินค้า (Grand Opening), การประชุมสัมมนาทางการ, กิจกรรม CSR, การถ่ายทอดสด Live Streaming และระบบลงทะเบียน Smart Check-in",
        ...
        description: "ออกแบบและพัฒนาเว็บไซต์อย่างเป็นทางการของบริษัท อโณณา อีเวนต์ พร้อมดูแลรักษาและอัปเดตระบบต่อเนื่องในระยะยาว",
        highlights: [
